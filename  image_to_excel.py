...
def image2excel(imgfile, excelfile):
    ...
    # inverting the image
    img_bin = 255 - img_bin
    cv2.imwrite('files/new_bl.jpg', img_bin)
    ...
    cv2.imwrite("files/new_bl_v.jpg", vertical_lines)
    ...
    cv2.imwrite("files/new_bl_h.jpg", horizontal_lines)
    # Plot the generated image
    ...
    cv2.imwrite("files/new_bl_img_vh.jpg", img_vh)
...
img_folder=Path('files')
excel_folder=Path('output_results')
tmp=Path('tmp')

...
image = process_image('data/floorplan_04.png')

df_rooms = process_floorplan('data/floorplan_04.png', resize_factor = 5)

df_rooms = process_floorplan('data/floorplan_01.jpeg', resize_factor = 5)

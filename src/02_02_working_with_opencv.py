...
Original file is located at
    https://colab.research.google.com/drive/1BzgvV6p72ibVMa6hW5ny8Lh-J4HgPQrR
...
image_file = "../data/original_new_bl.jpg"
# image_file = "../data/new_bl.jpg"
...
new = cv2.imread("../data/original_new_bl.jpg")
display("../data/original_new_bl.jpg")

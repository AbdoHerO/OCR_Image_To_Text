# -*- coding: utf-8 -*-
"""49973558-how-extract-text-from-a-picture-to-an-excel-sheet-using-tesseract-ocr.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18GnbxiY3XMcEc9xpP-Kabbj0bJpeW0Fk
"""
...
img = cv2.imread('new_bl_croped.jpg',0)
...
tt1 = cv2.dilate(want,kernel1,iterations=4)
...
# styled_data = dataframe.style

# # Apply CSS styling to the Styler object
# styled_data = styled_data.set_properties(**{'text-align': 'left'})
...
# cleaned_data = styled_data.applymap(lambda x: ''.join(filter(lambda c: c.isprintable(), x)))

# # Storing cleaned DataFrame in Excel format with specified encoding
# cleaned_data.to_excel("output.xlsx", encoding='utf-8', index=False)

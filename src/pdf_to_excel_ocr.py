...
#     # # Get Contract No.
#     # index = [i + 2 for i, x in enumerate(text) if x == "Command"]
#     # contract_no.append(text[index[0]])
#     #
#     # # Get Organisation type
#     # index = [i + 1 for i, x in enumerate(text) if x == "Livr"]
#     # org_type.append(text[index[0]])
#     #
#     # # Get Organisation ministry
#     # index = [i + 1 for i, x in enumerate(text) if x == "signation"]

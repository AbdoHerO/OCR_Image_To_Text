...
for i in range( 8  ):
        ...
        img_name = 'model0' + str(i + 1)
        img = cv2.imread('../data/models/' + img_name + '.jpeg')
        ...
        cv2.imwrite('../output_models/binary_' + img_name + '.jpeg', binary)
        cv2.imwrite('../output_models/sharpened_' + img_name + '.jpeg', sharpened___)

        cv2.imwrite('../data/binary_' + img_name + '.jpeg', binary)

        # *--------------------------------------------------------* Step 2 *--------------------------------------------------------*

        img_to_transformer_step_2 = cv2.imread('../data/binary_' + img_name + '.jpeg')
        ...
        cv2.imwrite('../output_models/bilateral_' + img_name + '.jpeg', output_bil)
        ...
        cv2.imwrite('../output_models/adaptive_' + img_name + '.jpeg', adaptive_result)
        # *--------------------------------------------------------* Show all Windows *--------------------------------------------------------*
